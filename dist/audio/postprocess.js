...
exports.decodeWavToPcm16 = decodeWavToPcm16;
exports.encodePcm16ToWav = encodePcm16ToWav;
exports.postprocessPcm16 = postprocessPcm16;
exports.postprocessTtsAudio = postprocessTtsAudio;
...
function resamplePcm16Linear(samples, inputSampleRateHz, outputSampleRateHz) {
    if (samples.length === 0)
        return samples;
...
function encodePcm16ToWav(samples, sampleRateHz) {
...
function postprocessPcm16(samples, sampleRateHz) {
    if (samples.length === 0) {
...
function postprocessTtsAudio(audio, options) {
    ...
    const resampledSamples = (() => {
        ...
        const output = resamplePcm16Linear(inputSamples, inputSampleRateHz, OUTPUT_SAMPLE_RATE_HZ);
