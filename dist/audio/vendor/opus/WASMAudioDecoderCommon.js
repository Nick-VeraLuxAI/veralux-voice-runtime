...
class WASMAudioDecoderCommon {
    ...
    static async initWASMAudioDecoder() {
        ...
        [this._inputPtr, this._input] = common.allocateTypedArray(this._inputPtrSize, Uint8Array);
        // output buffer
        [this._leftPtr, this._leftArr] = common.allocateTypedArray(this._outputPtrSize, Float32Array);
        [this._rightPtr, this._rightArr] = common.allocateTypedArray(this._outputPtrSize, Float32Array);
        return common;
    }
    ...
    static getDecodedAudioConcat(channelData, samplesDecoded, sampleRate) {
        return WASMAudioDecoderCommon.getDecodedAudio(channelData.map((data) => WASMAudioDecoderCommon.concatFloat32(data, samplesDecoded)), samplesDecoded, sampleRate);
    }
    ...
    static inflateYencString(source, dest) {
        ...
        let continued = false, byteIndex = 0, byte;
...
//# sourceMappingURL=WASMAudioDecoderCommon.js.map