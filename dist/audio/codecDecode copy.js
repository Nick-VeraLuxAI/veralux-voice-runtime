        ...
        try {
            ...
            try {
                    ...
                    if (take > 0) {
                        ...
                        if (r.bytesRead === buf.length) {
                            for (let i = 0; i < take; i += 1) {
                                ...
                                hasSeenFrameRecently(state, key, maxRecent);
                            }
                        }
                    }
                }
                ...
                for (const fr of afterAdj) {
                    const key = dedupeKeyForFrame(fr);
                    if (hasSeenFrameRecently(state, key, maxRecent)) {
                        droppedRecent += 1;
                        continue;
                    }
                    finalFrames.push(fr);
...
//# sourceMappingURL=codecDecode%20copy.js.map