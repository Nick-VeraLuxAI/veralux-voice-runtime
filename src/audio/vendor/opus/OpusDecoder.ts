// @ts-nocheck
import WASMAudioDecoderCommon from './WASMAudioDecoderCommon';

import EmscriptenWASM from './EmscriptenWasm';

export default class OpusDecoder {
  constructor(_WASMAudioDecoderCommon?: unknown, _EmscriptenWASM?: unknown) {
